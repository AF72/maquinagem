        ...
        <tbody>
          {historico.length === 0 ? (
            ...
            <tr key={h.id}>
              ...
              <td>
                <button className="btn btn-ghost btn-sm" style={{ color: 'var(--color-danger,#c00)' }} onClick={() => remover(h.id)} title="Remover"><svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></button>
              </td>
            </tr>
          ))}
        </tbody>
